...
from neurophotonics.populate.worker import _logger
from neurophotonics.populate.worker import standard_worker
...
def run(**kwargs):
    ...
    try:
        ...
        _logger.exception("Worker '{}' encountered an exception:".format(
            kwargs["worker_name"]))
